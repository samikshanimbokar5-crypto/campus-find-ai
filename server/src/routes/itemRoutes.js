...
import { createItem, listItems, getItem, myItems, updateItem, resolveItem, itemMatches, recoveryAnalytics } from '../controllers/itemController.js';
...
router.get('/analytics/recovery', asyncHandler(recoveryAnalytics));
